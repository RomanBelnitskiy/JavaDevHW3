...
INSERT INTO project(ID, CLIENT_ID, START_DATE, FINISH_DATE) VALUES 
  (1, 2, '2020-12-01', '2021-05-12'),
  (2, 1, '2021-05-18', '2023-08-01'),
  (3, 2, '2021-01-04', '2022-07-01'),
  (4, 3, '2021-05-15', '2023-01-01'),
  (5, 4, '2021-09-01', '2023-06-24'),
  (6, 5, '2021-12-10', '2023-02-08'),
  (7, 6, '2022-02-13', '2023-09-13'),
  (8, 1, '2022-05-20', NULL),
  (9, 4, '2022-08-06', '2023-02-25'),
  (10, 6, '2022-11-19', NULL),
  (11, 5, '2023-01-23', '2023-04-22'),
  (12, 3, '2023-04-01', NULL),
  (13, 1, '2023-07-07', NULL),
  (14, 4, '2023-08-06', NULL);
